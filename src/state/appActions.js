...
export const APP_ACTIONS = {
  ...
  ENSURE_CORE_BLOCK_LOG: "ENSURE_CORE_BLOCK_LOG",
  TOGGLE_EXERCISE_SET_DONE: "TOGGLE_EXERCISE_SET_DONE",
  TOGGLE_CORE_SET_DONE: "TOGGLE_CORE_SET_DONE",
  UPDATE_EXERCISE_SET_FIELD: "UPDATE_EXERCISE_SET_FIELD",
  UPDATE_CORE_SET_FIELD: "UPDATE_CORE_SET_FIELD",
  MARK_EXERCISE_CLOSED: "MARK_EXERCISE_CLOSED",

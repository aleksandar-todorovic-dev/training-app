/**
 * Static plan metadata for Bulk Pro.
 *
 * Runtime note:
...
export const bulkPro = {
  id: "bulk-pro",
  name: "Bulk Pro",
  goal: "Muscle-gain phase / structured progression",
  shortDescription:
  ...
  keyRules: [
    ...
    "Focus on quality sets and progressive overload",
    "Follow the cycle instead of a rigid weekly schedule",
  ],

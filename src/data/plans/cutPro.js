...
export const cutPro = {
  id: "cut-pro",
  name: "Cut Pro",
  goal: "Cut-phase training / muscle-retention support",
  shortDescription:
    "Lower-volume structured cut plan designed to support strength retention while keeping training fatigue more controlled.",
  audience:
    "Lifters training through a calorie deficit who want structured resistance work with tighter fatigue control.",
  ...
  keyRules: [
    ...
    "Aim to maintain useful strength while cutting",
  ],
